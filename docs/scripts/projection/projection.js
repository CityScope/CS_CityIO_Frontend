 ...
 function projection(jsonData) {

     ///////////////SETUP SCENE///////////////////////

     var CANVAS_WIDTH = document.getElementById('projectionDiv').clientWidth,
         CANVAS_HEIGHT = document.getElementById('projectionDiv').clientHeight;
     var frustumSize = 20;
     ...
     document.getElementById('projectionDiv').appendChild(renderer.domElement);

     Maptastic("projectionDiv");
 }