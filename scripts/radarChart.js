    ...
    function chart(selection) {
        selection.each(function () {
            ...
            updateData = function () {
                ...
                let update_radarCircle = update_blobWrapper.selectAll('.radarCircle')
                ...
                let update_radarInvisibleCircle = update_blobCircleWrapper.selectAll(".radarInvisibleCircle")
                    .data(function (d, i) { return add_index(d._i, d.values); });
